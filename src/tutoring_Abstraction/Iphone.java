...
public class Iphone implements PhoneFeatures {
    ...
    public void camera(String camera) {
        if (camera.endsWith("dual camera")) {
            System.out.println("It has dual front camera with 8-megapixel sensors each");
        } else {
            System.out.println("It has a front camera with 16-megapixel sensor");
        }
    }
    ...
    public void remoteControl(boolean isRemoteControl) {
        if (isRemoteControl == true) {
            System.out.println("It has infrared remote control feature which will allow to control your Apple TV ");
        } else {
            System.out.println("SORRY! You do not have the remote control feature in your version of iOS ");
        }
    }
}
